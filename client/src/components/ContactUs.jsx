  ...
  return (
    <section className="services section-bg">
      ...
      <div className="lg:flex">
        <div className="xl:w-2/5 lg:w-2/5 bg-[#37517e] py-16 xl:rounded-bl rounded-tl rounded-tr xl:rounded-tr-none">
          <div className="xl:w-5/6 xl:px-0 px-8 mx-auto">
            ...
            <div className="flex pb-4 items-center">
              ...
              <p className="pl-4 text-white text-base">+1 (012) 345 678</p>
            </div>
            <div className="flex items-center">
              ...
              <p className="pl-4 text-white text-base">Info@example.com</p>
            </div>
